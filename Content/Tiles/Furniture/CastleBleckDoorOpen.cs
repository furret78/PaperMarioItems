...
namespace PaperMarioItems.Content.Tiles.Furniture
{
	public class CastleBleckDoorOpen : ModTile
	{
		public override void SetStaticDefaults() {
			...
			TileID.Sets.CloseDoorID[Type] = PMTileID.CastleBleckDoorClosed;
			...
			RegisterItemDrop(PMItemID.CastleBleckDoor, 0);
			TileID.Sets.CloseDoorID[Type] = PMTileID.CastleBleckDoorClosed;
		...
		public override void MouseOver(int i, int j) {
			...
			player.cursorItemIconID = PMItemID.CastleBleckDoor;
		}
	}
}